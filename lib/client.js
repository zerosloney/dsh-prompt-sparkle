...
var CSS_TEXT = [
  ...
  /* Toast 样式 */
  '[data-dsh-prompt-sparkle-toast]{position:fixed;left:50%;bottom:96px;transform:translateX(-50%);max-width:min(560px,80vw);padding:7px 14px;border-radius:10px;z-index:60;pointer-events:auto;display:inline-flex;align-items:center;gap:10px;animation:dsh-prompt-sparkle-toast-in .18s ease-out both;font:var(--dsw-font-xxs-12,12px/normal system-ui,-apple-system,sans-serif);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
  ...
  /* Toast - 深色主题 */
  '[data-dsh-prompt-sparkle-toast][data-theme="dark"]{background:rgba(36,36,36,.94);color:#fafafa;box-shadow:0 4px 12px rgba(0,0,0,.25);}',
  ...
  /* 右键菜单基础结构 */
  '[data-dsh-prompt-sparkle-menu]{position:fixed;border-radius:10px;padding:6px;z-index:90;display:flex;flex-direction:column;gap:3px;min-width:215px;animation:dsh-prompt-sparkle-toast-in .14s ease-out both;backdrop-filter:blur(10px);}',
  '[data-dsh-prompt-sparkle-menu-header]{padding:4px 8px 6px;font:var(--dsw-font-xxs-11,11px/normal system-ui,-apple-system,sans-serif);font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px;}',
  ...
  '[data-dsh-prompt-sparkle-menu-item] .item-name{font:var(--dsw-font-xxs-12,12px/normal system-ui,-apple-system,sans-serif);font-weight:500;}',
  '[data-dsh-prompt-sparkle-menu-item] .item-desc{font-size:11px;}',
  ...
  '[data-dsh-prompt-sparkle-menu][data-theme="light"] [data-dsh-prompt-sparkle-menu-header]{color:#64748b;border-bottom:1px solid #f1f5f9;}',
  ...
  '[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-header]{color:rgba(255,255,255,.45);border-bottom:1px solid rgba(255,255,255,.08);}',
  '[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-divider]{background:rgba(255,255,255,.1);}',
  '[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-item]{color:#e6e6e6;}',
  ...
  '[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-item] .item-desc{color:rgba(255,255,255,.52);}',
  '[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-item]:hover .item-desc,[data-dsh-prompt-sparkle-menu][data-theme="dark"] [data-dsh-prompt-sparkle-menu-item][data-active] .item-desc{color:rgba(255,255,255,.78);}',

  /* Modal 基础结构 */
  '[data-dsh-prompt-sparkle-modal-backdrop]{position:fixed;inset:0;backdrop-filter:blur(6px);z-index:100;display:flex;align-items:center;justify-content:center;animation:dsh-prompt-sparkle-fade-in .15s ease-out both;}',
  '@keyframes dsh-prompt-sparkle-fade-in{from{opacity:0;}to{opacity:1;}}',
  '[data-dsh-prompt-sparkle-modal]{border-radius:14px;width:min(580px,92vw);max-height:85vh;display:flex;flex-direction:column;font:var(--dsw-font-xs-13,13px/1.5 system-ui,-apple-system,sans-serif);animation:dsh-prompt-sparkle-scale-in .18s cubic-bezier(.16,1,.3,1) both;overflow:hidden;}',
  ...
  '.dsh-sparkle-field-title{font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;}',
  ...
  '.dsh-sparkle-hint{font-size:11px;}',
  ...
  '.dsh-sparkle-diff-col-title{font-size:11px;font-weight:600;text-transform:uppercase;}',
  '.dsh-sparkle-diff-content{flex:1;border-radius:8px;padding:10px;font-family:monospace;font-size:12px;line-height:1.45;white-space:pre-wrap;word-break:break-word;overflow-y:auto;max-height:360px;}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="light"] .dsh-sparkle-field-title{color:#64748b;}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"]{background:var(--dsw-alias-bg-panel,#202020);color:var(--dsw-alias-fg-base,#e6e6e6);border:1px solid rgba(255,255,255,.14);box-shadow:0 16px 40px rgba(0,0,0,.5);}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] [data-dsh-prompt-sparkle-modal-close]{color:rgba(255,255,255,.5);}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-field-title{color:rgba(255,255,255,.6);}',
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-input,[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-select,[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-textarea{background:rgba(0,0,0,.35);border:1px solid rgba(255,255,255,.14);color:#fff;}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-hint{color:rgba(255,255,255,.45);}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-btn-subtle{background:transparent;color:rgba(255,255,255,.6);}',
  ...
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-diff-col-title{color:rgba(255,255,255,.5);}',
  '[data-dsh-prompt-sparkle-modal][data-theme="dark"] .dsh-sparkle-diff-content.original{color:rgba(255,255,255,.65);background:rgba(255,100,100,.04);border:1px solid rgba(255,100,100,.2);}',
...
function apply(ctx) {
  ...
  function openSettingsModal() {
    ...
    body.innerHTML = [
      ...
      '    <div style="font-size:11px;color:rgba(128,128,128,.9);font-weight:500;">从当前环境已配置的可用模型中快速选择：</div>',
